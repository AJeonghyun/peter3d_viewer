...
COMPOSE_MAX_CONCURRENT_TEAMS = 2
...
CAPTURE_ILLUSTRATION_SIZE = os.getenv("CAPTURE_ILLUSTRATION_SIZE", "1024x1440")
CAPTURE_ILLUSTRATION_QUALITY = os.getenv("CAPTURE_ILLUSTRATION_QUALITY", "medium")
CAPTURE_ILLUSTRATION_OUTPUT_FORMAT = "jpeg"
CAPTURE_ILLUSTRATION_OUTPUT_COMPRESSION = 90
